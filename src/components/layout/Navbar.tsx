      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-black border-b-4 border-white">
        <nav className="flex items-center justify-between px-6 md:px-12 h-16">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center px-5 py-2 font-black uppercase tracking-widest text-sm bg-[#FFDD00] text-black border-2 border-white shadow-[4px_4px_0_#fff] hover:shadow-[6px_6px_0_#fff] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all duration-150"
          >
            Hire me
          </a>
        ...
        {open && (
          ...
          >
            ...
            <a
              href="mailto:gabinhalloss@gmail.com"
              onClick={() => setOpen(false)}
              className="mt-8 inline-flex items-center px-6 py-3 font-black uppercase tracking-widest text-sm bg-[#FFDD00] text-black border-2 border-white shadow-[4px_4px_0_#fff]"
            >
              Hire me
            </a>
          </motion.div>
